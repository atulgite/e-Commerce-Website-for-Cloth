        ...
        return (
            <div className='login' >
                ...
                <div className='login_container'>
                    ...
                    <p>By signing in you will agree all the terms & condition by Cloth_hub</p>
                    <Link to="vendorregister" ><button className='innerbutton'> Create your Vendor's Cloth_hub Account</button></Link>
                </div>
            </div>
