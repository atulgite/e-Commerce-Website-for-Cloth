...
export default class AddProduct extends React.Component {
   ...
   /* handleOption= selectedOption => {
    ...
    submitForm = (e) => {
        ...
        fetch("http://localhost:8080/vaddproduct?cname="+this.state.selectedOption+"&ctype="+this.state.selectedOption1+"&vid="+sign.vid+"&pname="+this.state.title+"&pdesc="+this.state.describe+"&psize="+this.state.size+"&pbrand="+this.state.brand+"&pprice="+this.state.price+"&pqty="+this.state.qty)
            .then(resp => resp.json())
